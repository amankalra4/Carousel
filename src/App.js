	...
	<div style={styles}>
		<Carousel>
			<div>
				...
				<p className="legend">This place is Hong Kong</p>
			</div>
			<div>
				...
				<p className="legend">This place is Singapore</p>
			</div>
			<div>
				...
				<p className="legend">This placeis Japan</p>
			</div>
			<div>
				...
				<p className="legend">This place is Las Vegas</p>
			</div>
		</Carousel>
	</div>
  );
